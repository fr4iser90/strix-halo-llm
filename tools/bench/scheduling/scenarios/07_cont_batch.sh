...
# place that toggles it: restart_lab_server 0|1 → ephemeral compose overlay
# (tools/bench/lib/compose_overlay.sh). After the run, lab is restored with
# cont-batching ON.
set -euo pipefail
